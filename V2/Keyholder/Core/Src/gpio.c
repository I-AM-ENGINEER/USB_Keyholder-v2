...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, OLED_CS_Pin|VBUS_EN_Pin|OLED_DC_Pin|OLED_RES_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PA0 PA3 PA4 PA10 */
  ...
  GPIO_InitStruct.Pin = SW7_Pin|SW4_Pin|SW6_Pin|SW2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : PAPin PAPin PAPin */
  GPIO_InitStruct.Pin = SW8_Pin|SW5_Pin|SW1_Pin;
  ...
  GPIO_InitStruct.Pin = GPIO_PIN_0|GPIO_PIN_1|GPIO_PIN_2|GPIO_PIN_10
                          |GPIO_PIN_11|GPIO_PIN_14|GPIO_PIN_6;
  GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
