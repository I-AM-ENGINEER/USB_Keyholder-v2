...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, DISPLAY_ON2_Pin|DISPLAY_ON1_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = DISPLAY_ON2_Pin|DISPLAY_ON1_Pin;
  ...
  GPIO_InitStruct.Pin = SW4_Pin|SW5_Pin|SW6_Pin|SW7_Pin
                          |SW8_Pin|SW1_Pin|SW2_Pin|SW3_Pin;
